...
const Product: React.FC<IProduct> = ({ id, name, category, cost, image }) => {
  return (
    <Link href={`/${id}`}>
      <a className="m-3 w-96 text-left no-underline border border-solid border-purple-200 rounded-lg hover:shadow-md focus:shadow-md focus:outline-none">
        <div
          id="image"
